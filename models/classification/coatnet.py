...
def coatnet_0(image_size=(448, 448), in_channels=3, num_classes=1):
    num_blocks = [2, 2, 3, 5, 2]            # L
    channels = [64, 96, 192, 384, 768]      # D
    return CoAtNet(image_size, in_channels, num_blocks, channels, num_classes=num_classes)


def coatnet_1(image_size=(448, 448), in_channels=3, num_classes=1):
    num_blocks = [2, 2, 6, 14, 2]           # L
    channels = [64, 96, 192, 384, 768]      # D
    return CoAtNet(image_size, in_channels, num_blocks, channels, num_classes=num_classes)


def coatnet_2(image_size=(448, 448), in_channels=3, num_classes=1):
    num_blocks = [2, 2, 6, 14, 2]           # L
    channels = [128, 128, 256, 512, 1026]   # D
    return CoAtNet(image_size, in_channels, num_blocks, channels, num_classes=num_classes)


def coatnet_3(image_size=(448, 448), in_channels=3, num_classes=1):
    num_blocks = [2, 2, 6, 14, 2]           # L
    channels = [192, 192, 384, 768, 1536]   # D
    return CoAtNet(image_size, in_channels, num_blocks, channels, num_classes=num_classes)


def coatnet_4(image_size=(448, 448), in_channels=3, num_classes=1):
