...
class Ensemble(nn.Module):
    def __init__(
        self,
        resnet18_x_fn = './checkpoints/classification/resnet18/mip_x_pet_resnet18/fold_1/net_best_val_net_0.7961.pt',
        resnet18_y_fn = './checkpoints/classification/resnet18/mip_y_pet_resnet18/fold_1/net_best_val_net_0.8301.pt',
        resnet50_x_fn = './checkpoints/classification/resnet50/mip_x_pet_resnet50/fold_1/net_best_val_net_0.8350.pt',
        resnet50_y_fn = './checkpoints/classification/resnet50/mip_y_pet_resnet50/fold_1/net_best_val_net_0.8204.pt',
        resnet18_x_debrain_fn = './checkpoints/classification/debrain/resnet18/mip_x_pet_resnet18/fold_1/net_best_val_net_0.8447.pt',
        resnet18_y_debrain_fn = './checkpoints/classification/debrain/resnet18/mip_y_pet_resnet18/fold_1/net_best_val_net_0.8495.pt',
        resnet50_x_debrain_fn = './checkpoints/classification/debrain/resnet50/mip_x_pet_resnet50/fold_1/net_best_val_net_0.8398.pt',
        resnet50_y_debrain_fn = './checkpoints/classification/debrain/resnet50/mip_y_pet_resnet50/fold_1/net_best_val_net_0.8301.pt',
        args=None,
    ) -> None:
        ...
        self.resnet18_x =  ResNet(resnet_v='resnet18', in_channels=1, args=args).to(self.device)
        self.resnet18_y =  ResNet(resnet_v='resnet18', in_channels=1, args=args).to(self.device)
        self.resnet50_x =  ResNet(resnet_v='resnet50', in_channels=1, args=args).to(self.device)
        self.resnet50_y =  ResNet(resnet_v='resnet50', in_channels=1, args=args).to(self.device)
        self.resnet18_x_debrain =  ResNet(resnet_v='resnet18', in_channels=1, args=args).to(self.device)
        self.resnet18_y_debrain =  ResNet(resnet_v='resnet18', in_channels=1, args=args).to(self.device)
        self.resnet50_x_debrain =  ResNet(resnet_v='resnet50', in_channels=1, args=args).to(self.device)
        self.resnet50_y_debrain =  ResNet(resnet_v='resnet50', in_channels=1, args=args).to(self.device)
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        th = 0.025 # conservative threshold to avoid false negatives
    ...
    def gen_mip_with_brain(self, x): # assume x in shape (B, C, H, W, D)
        ...
        for b in range(x.shape[0]): # iterate over batch
            ...
            check_mip_x = np.load(f'./data/MIP/fold_0/val_data/mip_x/000{b}.npy')
