...
class BasicUNet(nn.Module):
    ...
    def __init__(
        ...
        self.upcat_4 = UpCat(spatial_dims, fea[3], fea[2], fea[2], act, norm, bias, dropout, upsample)
        self.upcat_3 = UpCat(spatial_dims, fea[2], fea[1], fea[1], act, norm, bias, dropout, upsample)
        self.upcat_2 = UpCat(spatial_dims, fea[1], fea[0], fea[4], act, norm, bias, dropout, upsample, halves=False)
    ...
    def forward(self, x: torch.Tensor):
        ...
        u4 = self.upcat_4(x3, x2)
        u3 = self.upcat_3(u4, x1)
        u2 = self.upcat_2(u3, x0)
